...
async function exportBackupData() {
  const [users, schools, schoolMemberships, schoolScoreTableSettings, schoolScoreTables, teacherClasses, teacherClassHistory, adminAuditLog, graphSnapshots] = await Promise.all([
